...
class _WeatherHomePageState extends State with SingleTickerProviderStateMixin {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Graphique centré avec style uniforme
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16),
                child: LayoutBuilder(
              ...
              SizedBox(
                ...
                child: Center(
                  child: ListView(
                    ...
                    children: filteredHours.map((hourData) {
                      final time = hourData['time'] as DateTime;
  ...
  Widget _buildWeeklyTab() {
    ...
    final effectiveScreenHeight = screenHeight < 667 ? 667.0 : screenHeight;
    ...
    return Column(
      children: [
        ...
        Center(
          child: Container(
            width: maxWidth * 0.95,
            height: effectiveScreenHeight * 0.35,
            decoration: BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.circular(12),
              boxShadow: [
              ...
              LineChartData(
                    ...
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, meta) {
                        ...
                        if (index >= 0 && index < weekData.length) {
                          return Text(
                            _shortDayName(weekData[index]['date'] as DateTime),
                            style: TextStyle(
                              fontSize: 12,
                              color: Colors.indigo[600],
                              fontWeight: FontWeight.bold,
                ...
                lineBarsData: [
                  LineChartBarData(
                    spots: [
                      for (int i = 0; i < weekData.length; i++)
                        FlSpot(i.toDouble(), (weekData[i]['temp_max'] as num).toDouble()),
                    ],
                    isCurved: true,
                    color: Colors.red,
                    barWidth: 4,
                  ...
                  LineChartBarData(
                    spots: [
                      for (int i = 0; i < weekData.length; i++)
                        FlSpot(i.toDouble(), (weekData[i]['temp_min'] as num).toDouble()),
                    ],
                    isCurved: true,
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text('Max: $tempMax°C', style: const TextStyle(color: Colors.red)),
                      Text('Min: $tempMin°C', style: const TextStyle(color: Colors.indigo)),
                      const SizedBox(height: 4),
                      Text(desc, style: const TextStyle(fontSize: 12), textAlign: TextAlign.center),
                    ],
                  ),
                );
              }).toList(),
